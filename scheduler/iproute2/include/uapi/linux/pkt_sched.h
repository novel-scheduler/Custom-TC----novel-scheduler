...
enum {
	...
	TCA_F1_SOURCEPORT,	/*f1 sourceport for the flows*/
	
	TCA_F2_SOURCEPORT,	/*f2 sourceport for the flows*/
	
	TCA_F1_DESTPORT,	/*f2 destport for the flows*/
	
	TCA_F2_DESTPORT,	/*f2 destport for the flows*/
